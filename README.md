...
class HealthMonitoringAgent:
    def _init_(self, patient_data, sensors, actuators):
...
## OUTPUT
<img width="927" height="126" alt="image" src="https://github.com/user-attachments/assets/3f4c4fa2-cdcc-4efe-ba03-1faba1d2c4db" />

## RESULT
Sccessfully developed an AI agent for given problem
